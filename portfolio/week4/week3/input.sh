#!/bin/bash
#Function to self contained inside of a method.
​# User-defined functions to check if entry is more that not equal to three,
#function to check files for time and date
